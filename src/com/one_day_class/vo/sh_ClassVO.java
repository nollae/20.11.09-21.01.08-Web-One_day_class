...
public class sh_ClassVO {
	String cid, email, regionmain, regionsub, catemain, catesub, ctype, title, picture, spicture, videos, schedule,
			tutornotice, tutorinfo, introduction, target, curriculum, cdate;
	...
	int person, price, time, wish_cnt, cstatus;
