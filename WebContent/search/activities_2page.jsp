			...
			<div class="main3_cont">
				...
				<div class="cont2_box" id="top-space">
					<div class="cont2">
						...
						<div class="cont2_class">
							<a href="http://localhost:9000/One_day_class/class/workout/act/w_a_1.jsp" target="_blank">
								<div class="img"
									style="background-image: url(http://localhost:9000/One_day_class/images/workout/w_a_1.png);">
									<div class="day">1DAY수업</div>
								...
								<div class="profile_box">
									<div class="profile"
										style="background-image: url(http://localhost:9000/One_day_class/images/workout/w_a_1_icon.png);">
									</div>
									<div class="name">이재원</div>
									<div class="nick">튜터</div>
								</div>
								<div class="title">오늘부터 내 목소리도 ASMR? 현직 게임 성우에게 직접 배우는 "성우연기&나레이션"</div>
								<div class="price">
									<div class="price2">
										<span>￦<span><span>13,500<span>
									</div>
						...
						<div class="cont2_class">
							<a href="http://localhost:9000/One_day_class/class/workout/act/w_a_2.jsp" target="_blank">
								<div class="img"
									style="background-image: url(http://localhost:9000/One_day_class/images/workout/w_a_2.png);">
									<div class="day">1DAY수업</div>
								...
								<div class="profile_box">
									<div class="profile"
										style="background-image: url(http://localhost:9000/One_day_class/images/workout/w_a_2_icon.png);">
									</div>
									<div class="name">김동규</div>
									<div class="nick">튜터</div>
								</div>
								<div class="title">무용전문스튜디오 R.se에서 진행되는 현대무용 전문 클래스!</div>
								<div class="price">
									<div class="price2">
										<span>￦<span><span>13,500<span>
									</div>
