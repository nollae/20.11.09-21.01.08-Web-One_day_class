...
<body>
   ...
   <div class="left">
      ...
      <div class="a-left">
         <div class="a-left-1">
            <img src="http://localhost:9000/One_day_class/images/psy/l_p_1_1.png"">
         </div>
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">[마곡역] 생각이 많을땐, 딱 1시간 그림으로 내 심리를 알아봐요❤️</p><br>
            ...
            <ul >
                  <li class="list">
                        ...
                        <label for ="leftradio"class="inp_radio">
                           <span class="left-box-span">12월 05일 토요일 (강서) 11:00 - 12:00</span>
                           <p class="left-box-p">마곡역 6번출구 워크박스 마곡점</p>
                        </label>
                  </li>
                  <li class="list">
                        <input type="radio" name="lradio" id="leftradio2" class="inp_label blind">
                        <label for ="leftradio2"class="inp_radio">
                           <span class="left-box-span">12월 05일 토요일 (강서) 9:30 - 10:30</span>
                           <p class="left-box-p">마곡역 6번출구 워크박스 마곡점</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for ="leftradio3"class="inp_radio">
                           <span class="left-box-span">12월 05일 토요일 (강서) 12:30 - 13:30</span>
                           <p class="left-box-p">마곡역 6번출구 워크박스 마곡점</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for ="leftradio4"class="inp_radio">
                           <span class="left-box-span">12월 05일 토요일 (온라인 Live) 14:00 - 15:00</span>
