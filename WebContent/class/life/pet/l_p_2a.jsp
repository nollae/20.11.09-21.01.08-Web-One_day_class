...
<body>
   ...
   <div class="left">
      ...
      <div class="a-left">
         <div class="a-left-1">
            <img src="http://localhost:9000/One_day_class/images/pet/l_p_2_1.png">
         </div>
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">[온라인 live/재료키트 배송] 핸드니팅, 집에서 쉽게 만들기 ♥ 바늘 대신 양팔로 같이 쿠션만들어요![암니팅]</p><br>
            ...
            <ul >
                  <li class="list">
                        ...
                        <label for ="leftradio" class="inp_radio">
                           <span class="left-box-span">12월 04일 금요일 (온라인 Live) 18:30 - 19:30</span>
                  ...
                  <li class="list">
                        ...
                        <label for ="leftradio2" class="inp_radio">
                           <span class="left-box-span">12월 11일 금요일 (온라인 Live) 18:30 - 19:30</span>
                           <p class="left-box-p">협의 후 상세 장소 결정</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for ="leftradio3" class="inp_radio">
                           <span class="left-box-span">12월 18일 금요일 (온라인 Live) 18:30 - 19:30</span>
                           <p class="left-box-p">협의 후 상세 장소 결정</p>
                        </label>
                  </li>
            </ul>
