...
<body>
   ...
   <div class="left">
      ...
      <div class="a-left">
         <div class="a-left-1">
            <img src="http://localhost:9000/One_day_class/images/interior/l_i_1_1.png"">
         </div>
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">[1:1] 효과적인 가구배치와 소품 스타일링 방법! 라이프스타일에 맞는 홈스타일링!</p><br>
            ...
            <ul >
                  <li class="list">
                        ...
                        <label for ="leftradio" class="inp_radio">
                           <span class="left-box-span">협의 후 날짜 결정 (마포) 협의 후 시간 결정</span>
                  ...
                  <li class="list">
                        ...
                        <label for ="leftradio2" class="inp_radio">
                           <span class="left-box-span">협의 후 날짜 결정 (일산) 협의 후 시간 결정</span>
                           <p class="left-box-p">협의 후 상세 장소 결정</p>
                        </label>
                  </li>
            </ul>
