...
<body>
   ...
   <div class="left">
      ...
      <div class="a-left">
         <div class="a-left-1">
            <img src="http://localhost:9000/One_day_class/images/interior/l_i_3_1.png"">
         </div>
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">[원데이/온라인] 업계 사람들은 알려주지 않는 '눈길끄는' 인테리어의 비밀 (손쉽게 상업공간브랜딩 하자)</p><br>
            ...
            <ul >
                  ...
                  <li class="list">
                        ...
                        <label for ="leftradio2"class="inp_radio">
                           <span class="left-box-span">12월 16일 수요일 (온라인 Live) 19:30 - 22:30</span>
                           <p class="left-box-p">온라인 화상회의(추후안내)</p>
                        </label>
                  </li>
            </ul>
         </div>
