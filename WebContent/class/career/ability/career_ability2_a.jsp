...
<body>
	...
	<div class="left">
		...
		<div class="a-left">
			<div class="a-left-1">
				<img src="http://localhost:9000/One_day_class/images/career/ability/ability1_ (1).png">
			</div>
			<div class="a-left-2" style="width:281px;">
				<p class="a-title-1">[직장인들의 인생강의] 실전, 비즈니스 환경에 최적화된 보고서/기획서 작성과 보고 기법 (국내 대기업 & 외국계기업): 기본과정</p><br>
				...
				<ul>
						<li class="list">
							...
							<label for="leftradio1" class="inp_radio">
								<span class="left-box-span">12월 13일 (일) 10:00-16:00</span>
								<p class="left-box-p">강남구청역</p>
							</label>
						</li>
						<li class="list">
						...
						<li class="list" style="border-bottom:none;">
							...
							<label for="leftradio4" class="inp_radio">
								<span class="left-box-span">협의 후 날짜, 시간 결정</span>
								<p class="left-box-p">강남구청역</p>
							</label>
						</li>
				</ul>
