...
<body>
   ...
   <div class="left">
      ...
      <div class="a-left">
         <div class="a-left-1">
            <img src="http://localhost:9000/One_day_class/images/beauty/PT_GX/b_p_4_1.png">
         </div>
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">[강남/교대]1:1 체형교정 기구필라테스 제대로 뽀개기 !! #재활 #교정 #다이어트</p><br>
            <span class="star_box">
