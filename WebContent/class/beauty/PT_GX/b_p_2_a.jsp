...
<body>
   ...
   <div class="left">
      ...
      <div class="a-left">
         <div class="a-left-1">
            <img src="http://localhost:9000/One_day_class/images/beauty/PT_GX/b_p_2_1.png">
         </div>
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">[원데이 / 1:1] 만족스럽지 않은 내 몸매? 이젠 나의 숨은 라인과 키를 찾아보자!</p><br>
            <span class="star_box">
            ...
            <ul>
                  <li class="list">
                        ...
                        <label for="leftradio1" class="inp_radio">
                           <span class="left-box-span">12월 05일 토요일(강남) 11:00-13:00</span>
                  ...
                  <li class="list">
                        ...
                        <label for="leftradio2" class="inp_radio">
                           <span class="left-box-span">12월 05일 토요일(강남) 13:00-15:00</span>
                           <p class="left-box-p">협의 후 상세 장소 결정</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for="leftradio3" class="inp_radio">
                           <span class="left-box-span">12월 06일 일요일(건대) 11:00-13:00</span>
                           <p class="left-box-p">협의 후 상세 장소 결정</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for="leftradio4" class="inp_radio">
                           <span class="left-box-span">12월 06일 일요일(건대) 13:00-15:00</span>
                           <p class="left-box-p">협의 후 상세 장소 결정</p>
                        </label>
                  </li>
            </ul>
