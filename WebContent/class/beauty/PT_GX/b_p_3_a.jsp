...
<body>
   ...
   <div class="left">
      ...
      <div class="a-left">
         <div class="a-left-1">
            <img src="http://localhost:9000/One_day_class/images/beauty/PT_GX/b_p_3_1.png">
         </div>
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">[원데이/1:2]거북목,허리통증 언제까지 갖고있을래? 연예인운동 #SNPE</p><br>
            <span class="star_box">
            ...
            <ul>
                  <li class="list">
                        ...
                        <label for="leftradio1" class="inp_radio">
                           <span class="left-box-span">12월 02일 수요일(강남) 17:00-19:00</span>
                           <p class="left-box-p">서초구 주흥 3길 6 피치홈트</p>
                        </label>
                  </li>
                  <li class="list">
                        <input type="radio" name="lradio" id="leftradio2" class="inp_label blind">
                        <label for="leftradio2" class="inp_radio">
                           <span class="left-box-span">12월 03일 목요일(마포) 11:00-12:00</span>
                           <p class="left-box-p">월드컵로 3길 31-31 달리운동장</p>
                        </label>
                  </li>
                  <li class="list">
                        <input type="radio" name="lradio" id="leftradio3" class="inp_label blind">
                        <label for="leftradio3" class="inp_radio">
                           <span class="left-box-span">12월 05일 토요일(마포) 11:00-12:00</span>
                           <p class="left-box-p">월드컵로 3길 31-31 달리운동장</p>
                        </label>
                  </li>
            </ul>
