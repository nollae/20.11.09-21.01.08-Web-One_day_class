...
<body>
   ...
   <div class="left">
      ...
      <div class="a-left">
         <div class="a-left-1">
            <img src="http://localhost:9000/One_day_class/images/beauty/makeUp/b_m_1_1.png">
         </div>
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">[1:1_청담샵 경력] ❤ 강남역오픈❤ 자존감이 두배 올라가는 메이크업!</p><br>
            <span class="star_box">
            ...
            <ul>
                  <li class="list">
                        ...
                        <label for="leftradio1" class="inp_radio">
                           <span class="left-box-span">12월 03일 목요일(강남) 14:00-16:00</span>
                           <p class="left-box-p">인스터디카페 강남점</p>
                        </label>
                  </li>
                  <li class="list">
                        <input type="radio" name="lradio" id="leftradio2" class="inp_label blind">
                        <label for="leftradio2" class="inp_radio">
                           <span class="left-box-span">12월 03일 목요일(강남) 17:00-19:00</span>
                           <p class="left-box-p">인스터디카페 강남점</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for="leftradio3" class="inp_radio">
                           <span class="left-box-span">12월 03일 목요일(강남) 19:00-21:00</span>
                           <p class="left-box-p">인스터디카페 강남점</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for="leftradio4" class="inp_radio">
                           <span class="left-box-span">12월 04일 금요일(강남) 14:00-16:00</span>
                           <p class="left-box-p">인스터디카페 강남점</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for="leftradio5" class="inp_radio">
                           <span class="left-box-span">12월 04일 금요일(강남) 17:00-19:00</span>
                           <p class="left-box-p">인스터디카페 강남점</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for="leftradio6" class="inp_radio">
                           <span class="left-box-span">12월 04일 금요일(강남) 19:00-21:00</span>
                           <p class="left-box-p">인스터디카페 강남점</p>
                        </label>
                  </li>
            </ul>
