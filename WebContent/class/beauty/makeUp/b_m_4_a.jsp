...
<body>
   ...
   <div class="left">
      ...
      <div class="a-left">
         <div class="a-left-1">
            <img src="http://localhost:9000/One_day_class/images/beauty/makeUp/b_m_4_1.png">
         </div>
            ...
            <ul>
                  <li class="list">
                        ...
                        <label for="leftradio1" class="inp_radio">
                           <span class="left-box-span">12월 03일 목요일(강서) 18:00-22:00</span>
                           <p class="left-box-p">까치산역 도보 7분 이유쌤 작업실</p>
                        </label>
                  </li>
                  <li class="list">
                        <input type="radio" name="lradio" id="leftradio2" class="inp_label blind">
                        <label for="leftradio2" class="inp_radio">
                           <span class="left-box-span">12월 04일 금요일(강서) 18:00-22:00</span>
                           <p class="left-box-p">까치산역 도보 7분 이유쌤 작업실</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for="leftradio3" class="inp_radio">
                           <span class="left-box-span">12월 17일 목요일(강서) 18:00-22:00</span>
                           <p class="left-box-p">까치산역 도보 7분 이유쌤 작업실</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for="leftradio4" class="inp_radio">
                           <span class="left-box-span">12월 18일 금요일(강서) 18:00-22:00</span>
                           <p class="left-box-p">까치산역 도보 7분 이유쌤 작업실</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for="leftradio5" class="inp_radio">
                           <span class="left-box-span">12월 22일 화요일(강서) 14:00-18:00</span>
                           <p class="left-box-p">까치산역 도보 7분 이유쌤 작업실</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for="leftradio6" class="inp_radio">
                           <span class="left-box-span">협의 후 날짜 결정 (강서) 협의 후 시간 결정</span>
                           <p class="left-box-p">까치산역 도보 7분 이유쌤 작업실</p>
                        </label>
                  </li>
            </ul>
