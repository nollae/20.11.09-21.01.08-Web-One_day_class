...
<body>
   ...
   <div class="left">
      ...
      <div class="a-left">
         <div class="a-left-1">
            <img src="http://localhost:9000/One_day_class/images/beauty/makeUp/b_m_3_1.png">
         </div>
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">[원데이 메이크업]뭘 바르냐가 아니라, '어떻게'바르냐의 차이.</p><br>
            <span class="star_box">
            ...
            <ul>
                  <li class="list">
                        ...
                        <label for="leftradio1" class="inp_radio">
                           <span class="left-box-span">12월 07일 월요일(신촌홍대) 17:00-19:00</span>
                           <p class="left-box-p">경의선 숲길 인근 개인스튜디오에서 진행</p>
                        </label>
                  </li>
                  <li class="list">
                        <input type="radio" name="lradio" id="leftradio2" class="inp_label blind">
                        <label for="leftradio2" class="inp_radio">
                           <span class="left-box-span">12월 08일 화요일(신촌홍대) 19:30-21:30</span>
                           <p class="left-box-p">경의선 숲길 인근 개인스튜디오에서 진행</p>
                        </label>
                  </li>
            </ul>
