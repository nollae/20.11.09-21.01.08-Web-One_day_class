...
<body>
   ...
   <div class="left">
      ...
      <div class="a-left">
         <div class="a-left-1">
            <img src="http://localhost:9000/One_day_class/images/beauty/fashion/b_f_1_1.png">
         </div>
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">[가성비갑 쇼핑메이트][1:1 원데이] 현직 패션 소재 디자이너와 함께하는 가격대비 좋은 옷 고르기!</p><br>
            <span class="star_box">
