...
<body>
   ...
   <div class="left">
      ...
      <div class="a-left">
         <div class="a-left-1">
            <img src="http://localhost:9000/One_day_class/images/beauty/fashion/b_f_2_1.png">
         </div>
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">★할인특가★[피부/패션/스타일링] 완벽한 첫인상을 사로잡는 옴므그루밍 클래스</p><br>
            <span class="star_box">
            ...
            <ul>
                  <li class="list">
                        ...
                        <label for="leftradio1" class="inp_radio">
                           <span class="left-box-span">협의 후 날짜 결정 (분당) 협의 후 시간 결정</span>
