...
<body>
   ...
   <div class="left">
      ...
      <div class="a-left">
         <div class="a-left-1">
            <img src="http://localhost:9000/One_day_class/images/beauty/selfCare/b_s_1_1.png">
         </div>
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">[1:1봉고데기/여신웨이브] 샵 한번 갈 돈으로 평생 써먹자!!</p><br>
            <span class="star_box">
