...
<body>
   ...
   <div class="left">
      ...
      <div class="a-left">
         <div class="a-left-1">
            <img src="http://localhost:9000/One_day_class/images/beauty/selfCare/b_s_2_1.png">
         </div>
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">★할인이벤트★ 여드름 1:1 맞춤(스킨케어 포함)</p><br>
            <span class="star_box">
            ...
            <ul>
                  <li class="list">
                        ...
                        <label for="leftradio1" class="inp_radio">
                           <span class="left-box-span">12월 02일 수요일(강남) 11:00-13:00</span>
                  ...
                  <li class="list">
                        ...
                        <label for="leftradio2" class="inp_radio">
                           <span class="left-box-span">12월 02일 수요일(강남) 14:00-16:00</span>
                           <p class="left-box-p">협의 후 상세 장소 결정</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for="leftradio3" class="inp_radio">
                           <span class="left-box-span">12월 02일 수요일(강남) 19:00-21:00</span>
                           <p class="left-box-p">협의 후 상세 장소 결정</p>
                        </label>
                  </li>
                  <li class="list">
                  ...
                  <li class="list">
                        ...
                        <label for="leftradio5" class="inp_radio">
                           <span class="left-box-span">12월 09일 수요일(강남) 14:00-16:00</span>
                           <p class="left-box-p">협의 후 상세 장소 결정</p>
                        </label>
                  </li>
                  <li class="list">
