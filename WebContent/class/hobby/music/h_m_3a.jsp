   ...
   <div class="left">
      ...
      <div class="a-left">
         ...
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">[탈잉1위/당산역 3분]내가 좋아하는 음악으로 배우는 기타! (통기타/일렉기타/클래식기타)</p><br>
            ...
            <ul >
                  <li class="list">
                        ...
                        <label class="inp_radio">
                           <span class="left-box-span">협의 후 날짜 결정 () 협의 후 시간 결정</span>
                  ...
                  <li class="list">
                        ...
                        <label for ="leftradio2" class="inp_radio">
                           <span class="left-box-span">12월 14일 월요일 (영등포) 19:00 - 20:00</span>
                           <p class="left-box-p">당산 르네상스한강오피스텔</p>
                        </label>
                  </li>
                  <li class="list">
                        <input type="radio" name="lradio" id="leftradio3" class="inp_label blind">
                        <label for ="leftradio3" class="inp_radio">
                           <span class="left-box-span">12월 15일 화요일 (영등포) 19:00 - 20:00</span>
                           <p class="left-box-p">당산 르네상스한강오피스텔</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for ="leftradio4" class="inp_radio">
                           <span class="left-box-span">12월 16일 수요일 (영등포) 19:00 - 20:00</span>
                           <p class="left-box-p">당산 르네상스한강오피스텔</p>
                        </label>
                  </li>
            </ul>
