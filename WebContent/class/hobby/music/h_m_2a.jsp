   ...
   <div class="left">
      ...
      <div class="a-left">
         ...
         <div class="a-left-2" style="width:281px;">
            <p class="a-title-1">[원데이/음성검사] 더 이상 잘못된 발성은 그만!</p><br>
            ...
            <ul >
                  ...
                  <li class="list">
                        ...
                        <label for ="leftradio2" class="inp_radio">
                           <span class="left-box-span">협의 후 날짜 결정 (목동) 협의 후 시간 결정</span>
                           <p class="left-box-p">협의 후 상세 장소 결정</p>
                        </label>
                  </li>
                  <li class="list">
                        ...
                        <label for ="leftradio3"class="inp_radio">
                           <span class="left-box-span">12월 06일 일요일 (목동) 13:00 - 14:00</span>
                           <p class="left-box-p">신정동 1004-7</p>
                        </label>
                  </li>
                  <li class="list">
                        <input type="radio" name="lradio"  id="leftradio4" class="inp_label blind">
                        <label for ="leftradio4"class="inp_radio">
                           <span class="left-box-span">12월 06일 일요일 (목동) 14:00 - 15:00</span>
                           <p class="left-box-p">신정동 1004-7</p>
                        </label>
                  </li>
            </ul>
